...
CUE_ENGINE_REVISION = "806821e40fae070318600a264d311517e596353b"
...
def _backend_identity() -> BackendIdentity:
    return BackendIdentity(
        ...
        engine_revision=CUE_ENGINE_REVISION,
        cue_module_version=CUE_MODULE_VERSION,
        python_version=platform.python_version(),
        platform=platform.platform(),
        libcue_revision=LIBCUE_REVISION,
        upstream_libcue_module_version=UPSTREAM_LIBCUE_MODULE_VERSION,
        engine_rebound=True,
    )
