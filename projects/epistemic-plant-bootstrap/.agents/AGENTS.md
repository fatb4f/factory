...
1. Read the current shared upstream-monitor authority and every current CUE file in `contracts/factory/workers/upstream-monitor/profiles_epistemic_plant_bootstrap/`.
2. Read `contracts/upstream-monitor/epistemic-plant-bootstrap/contract-surface/AGENTS.md` and its report template.
