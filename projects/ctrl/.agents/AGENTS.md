...
1. Read `.agents/workers/upstream-monitor/AGENTS.md`, `contracts/workers/upstream-monitor/contract.cue`, and every current CUE file in `contracts/workers/upstream-monitor/profiles_ctrl/`.
