...
ankleKneePelvisTriSessionV1: #TriSessionProgram & {
	...
	sessions: [
		...
		},
		{
			...
			objective: "Integrate foot-ankle, femoral, pelvic, adductor-glute, trunk, and contralateral control under progressively less constrained whole-body tasks."
			invariant: "Program C prioritizes positional integrity and redistribution over fatigue: establish constrained cooperation, then frontal-plane negotiation, then unilateral whole-body equilibrium, terminating when foot, knee, femur, pelvis, or trunk organization is lost."
			exposures: [
				{exercise: {id: "backward-walk"}, phase: "primer", role: "primer", sets: 1, intent: "Low-cost locomotor entry and knee/ankle coordination before integration work.", constraints: ["easy-pace", "controlled-knee-track", "no-conditioning-target"]},
				{exercise: {id: "ankle-inversion-eversion"}, phase: "activation", role: "activation-gate", sets: 1, reps: {min: 8, max: 12}, intent: "Make frontal-plane distal control available without consuming the integration budget."},
				{exercise: {id: "ankle-dorsiflexion"}, phase: "activation", role: "activation-gate", sets: 1, reps: {min: 10, max: 20}, intent: "Prepare active dorsiflexion and deceleration control."},
				{exercise: {id: "calf-raise-neutral"}, phase: "activation", role: "activation-gate", sets: 1, reps: {min: 8, max: 12}, intent: "Prepare plantar-flexion and push-off while preserving clean foot-pressure transition."},
				{exercise: {id: "eagle-pose"}, phase: "primer", role: "primer", sets: 1, hold: {min: 10, max: 30}, optional: true, intent: "Cross-body standing constraint for stacked ankle-knee-hip control and rotational organization.", constraints: ["submaximal-hold", "steady-breathing", "no-forced-end-range"]},
				{exercise: {id: "standing-bow-pose"}, phase: "primer", role: "primer", sets: 1, hold: {min: 10, max: 30}, intent: "Whole-body unilateral integration reference: stance support, rear-leg drive, anterior reach, pelvic control, and contralateral force transfer.", constraints: ["submaximal-hold", "pelvis-organized", "stance-foot-organized", "steady-breathing", "no-forced-end-range"], stopOn: ["stance-foot-collapse", "knee-track-loss", "pelvic-rotation-loss", "uncontrolled-trunk-compensation"]},
				{exercise: {id: "balancing-stick-pose"}, phase: "primer", role: "primer", sets: 1, hold: {min: 10, max: 30}, optional: true, intent: "Bridge Standing Bow mechanics toward the long-axis unilateral hinge used by the modified SLRDL.", constraints: ["submaximal-hold", "long-axis-control", "pelvis-organized", "steady-breathing"]},
				{exercise: {id: "frog-glute-bridge"}, phase: "integration", role: "integration", sets: 2, reps: {min: 8, max: 15}, intent: "Establish constrained bilateral glute-adductor cooperation before long-range unilateral frontal-plane loading.", constraints: ["soles-together", "knees-near-90-degrees", "active-outward-knee-drive", "hip-extension-without-lumbar-extension", "symmetric-pelvis"], stopOn: ["lumbar-extension-substitution", "pelvic-rotation", "loss-of-symmetric-outward-pressure"]},
				{exercise: {id: "cossack-squat"}, phase: "main", role: "primary", sets: 2, reps: {min: 6, max: 10}, assistance: "as-needed-for-clean-range", intent: "Load long-range adductor capacity and frontal-plane femur-pelvis negotiation under lateral displacement.", constraints: ["receiving-foot-organized", "controlled-knee-track", "pelvis-organized", "extended-leg-position-controlled"], stopOn: ["foot-collapse", "uncontrolled-knee-or-femoral-rotation", "pelvic-position-loss"], progression: ["increase-clean-rom", "reduce-assistance", "increase-reps", "add-external-load"]},
				{exercise: {id: "modified-standing-bow-slrdl"}, phase: "main", role: "primary", sets: 3, reps: {min: 6, max: 8}, assistance: "enough-to-preserve-whole-body-organization", intent: "Resistance-oriented projection of Standing Bow: integrate stance-foot support, femoral control, hip hinge, rear-leg counterforce, stance-hip abduction, pelvic organization, and contralateral reach.", constraints: ["stance-foot-organized", "controlled-knee-track", "pelvis-organized", "rear-leg-active", "contralateral-reach-controlled", "no-lumbar-rescue"], stopOn: ["stance-foot-collapse", "uncontrolled-femoral-rotation", "pelvic-hike-or-rotation", "trunk-escape", "lumbar-substitution"], progression: ["increase-clean-range", "reduce-assistance", "increase-reps", "add-external-load"]},
				{exercise: {id: "triangle-pose"}, phase: "integration", role: "integration", sets: 1, hold: {min: 10, max: 30}, optional: true, intent: "Frontal-plane and rotational whole-body constraint after loaded integration work.", constraints: ["submaximal-hold", "feet-organized", "pelvis-controlled", "steady-breathing", "no-forced-end-range"]},
				{exercise: {id: "copenhagen"}, phase: "core", role: "core", sets: 2, hold: {min: 10, max: 20}, optional: true, intent: "Direct adductor-trunk force-transfer constraint when additional medial-chain exposure is useful.", constraints: ["hips-torso-stacked", "no-rib-flare", "no-pelvic-rotation", "no-hip-hike"]},
				{exercise: {id: "pallof-press"}, phase: "core", role: "core", sets: 2, reps: {min: 5, max: 8}, optional: true, intent: "Anti-rotation constraint for trunk-pelvis transfer."},
				...
				{exercise: {id: "treadmill-walk"}, phase: "downregulation", role: "downregulation", sets: 1, intent: "Read whether integrated capacity transfers into heel loading, pronation, midstance, resupination, and push-off; light jogging may follow only if gait remains organized.", constraints: ["easy-pace", "stop-if-gait-degrades"]},
				{exercise: {id: "backward-walk"}, phase: "downregulation", role: "downregulation", sets: 1, optional: true, intent: "Short post-session coordination readout, not conditioning."},
			]
			completion: {mechanicalFailureAllowed: false, compensationAllowed: false, requiresGaitReadout: true}
		},
	]
