...
import (
	...
	graph "github.com/fatb4f/factory/contracts/plugin-bundle/agent-context-resolver/src/contracts/agent-context-resolver/internal/graph:graph"
	"list"
	impl "github.com/fatb4f/factory/contracts/meta"
)

// source: contracts/plugin-bundle/agent-context-resolver/src/contracts/agent-context-resolver/manifest.cue
...
_materializedBundleShape: tmpl.#PluginBundleSrcRootShape & {
	srcRoot: "contracts/plugin-bundle/agent-context-resolver/src/contracts/agent-context-resolver"
	contracts: {
		root: "contracts/plugin-bundle/agent-context-resolver/src/contracts/agent-context-resolver"
		cuePackages: [
	...
	validation: {
		commands: [
			...
			"cue export ./contracts/plugin-bundle/agent-context-resolver/src/contracts/agent-context-resolver -e normalizedMaterializedBundleShapeManifest",
		]
...
materializedBundleShapeValidationPlan: close({
	path:     "contracts/plugin-bundle/agent-context-resolver/src/contracts/agent-context-resolver"
...
pluginBundleContract:         normalizedMaterializedBundleShapeManifest
pluginBundleValidationPlan:   materializedBundleShapeValidationPlan
pluginBundleCompletionReport: materializedBundleShapeCompletionReportContract
...
_pluginBundleRecommendationSlice: {
	...
	path:              "contracts/plugin-bundle/agent-context-resolver/src/contracts/agent-context-resolver/manifest.cue"
...
_pluginBundleTargetPaths: [
	...
	"contracts/plugin-bundle/agent-context-resolver/src/contracts/agent-context-resolver/generated/*.json",
	"contracts/plugin-bundle/agent-context-resolver/src/contracts/agent-context-resolver/projections/codex/hooks.json",
]
...
routeCompilerProof: #ResolvedRoutePlan & {
	...
	mergeReducer: {
		...
		packet: {
			...
			facts: []
			evidence: [
				{kind: "contract", ref: "contracts/plugin-bundle/agent-context-resolver/src/contracts/agent-context-resolver/manifest.cue"},
				{kind: "contract", ref: "contracts/plugin-bundle/agent-context-resolver/src/contracts/agent-context-resolver/manifest.cue"},
			]
			diagnostics: []
			conflicts: []
...
repoRegistry: #RepoContractRegistry & {
	...
	contracts: [
		...
		},
		{
			id:            "agent-runtime"
			authorityRoot: pluginLocalResolverRoot
			contractPath:  pluginLocalSourcePaths.routeInventory
			fragments: [{
				id:             "agent-runtime.authority"
				sourceContract: "agent-runtime"
				sourcePath:     pluginLocalSourcePaths.routeInventory
				sourceAuthorityPath: "contracts/agent-runtime/manifest.cue"
				pathLocality:   "installed-plugin"
				role:           "authority"
				surface:        "turn_start"
		...
		},
		{
			...
			fragments: [
				...
				},
				{
					...
					sourceContract: "repo"
					sourcePath:     pluginLocalSourcePaths.fragmentInventory
					sourceAuthorityPath: "contracts/repo/contract_seed.cue"
					pathLocality:   "installed-plugin"
					role:           "authority"
					surface:        "turn_start"
			...
			fragments: [
				{
					...
					sourcePath:     pluginLocalSourcePaths.fragmentInventory
					sourceAuthorityPath: "contracts/repo/manifest.cue"
					pathLocality:   "installed-plugin"
					role:           "authority"
					surface:        "turn_start"
				...
				},
				{
					...
					sourceContract: "vb-contract"
					sourcePath:     pluginLocalSourcePaths.fragmentInventory
					sourceAuthorityPath: "contracts/repo/component_seed.cue"
					pathLocality:   "installed-plugin"
					role:           "constraint"
					surface:        "turn_start"
				...
				},
				{
					...
					sourceContract: "vb-contract"
					sourcePath:     pluginLocalSourcePaths.fragmentInventory
					sourceAuthorityPath: "contracts/repo/virtual_branch.cue"
					pathLocality:   "installed-plugin"
					role:           "constraint"
					surface:        "turn_start"
...
#RouteInventory: close({
	generatedFrom: "contracts/plugin-bundle/agent-context-resolver/src/contracts/agent-context-resolver/manifest.cue"
