...
ankleKneePelvisTriSessionV1: #TriSessionProgram & {
	...
	sessions: [
		...
		{
			kind: "anterior"
			objective: "Restore anterior-chain and rotational femoral capacity while maintaining pelvic and trunk organization."
			invariant: "Reverse-Nordic and unilateral depth advance through controlled ROM before external load."
			exposures: [
				...
				{exercise: {id: "reverse-nordic"}, phase: "main", role: "primary", sets: 3, reps: {min: 5, max: 8}, constraints: ["hips-extended", "ribs-stacked", "pelvis-organized", "no-lumbar-extension-for-depth"], stopOn: ["pelvic-position-loss", "lumbar-substitution", "uncontrolled-knee-or-femoral-rotation"], progression: ["increase-clean-rom", "slow-eccentric", "add-external-load"]},
				{exercise: {id: "curtsey-stepdown"}, phase: "main", role: "secondary", sets: 2, reps: {min: 5, max: 8}, intent: "Expose femoral rotation and frontal-plane control under a stable pelvis.", constraints: ["pelvis-organized", "controlled-knee-track"]},
