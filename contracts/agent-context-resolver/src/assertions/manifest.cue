...
import (
	...
	runtimeprojection "github.com/fatb4f/factory/contracts/plugin-bundle/agent-context-resolver/src/projections/agent-runtime:runtimeprojection"
)

// source: contracts/agent-context-resolver/src/assertions/manifest.cue
