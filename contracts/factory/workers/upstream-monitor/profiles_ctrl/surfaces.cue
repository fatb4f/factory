...
ctrlSurfaceCatalogue: [
	...
	{id: "scip-semantic-identity", source: "scip", terms: ["SCIP", "symbol", "occurrence", "document", "relationship", "definition", "reference", "source range"], impactFloor: "contract-update", localContractHint: "cross-file symbol identity spine joining analyzer occurrences to CPython/runtime evidence without overriding CPython semantics", localPaths: ["packages/qualification-workflow/", "spec/profiles/", "integrations/openai/"]},
	...
	{id: "arrow-typed-relations", source: "arrow", terms: ["Arrow", "Table", "RecordBatch", "Schema", "IPC", "PyArrow"], impactFloor: "note", localContractHint: "typed columnar interchange for normalized python-intel/ctrl observations", localPaths: ["packages/qualification-workflow/", "spec/profiles/"]},
	{id: "duckdb-relational-substrate", source: "duckdb", terms: ["DuckDB", "relation", "SQL", "Arrow", "Parquet", "extension"], impactFloor: "note", localContractHint: "relational substrate over normalized evidence; never qualification authority", localPaths: ["packages/qualification-workflow/", "spec/profiles/"]},
	{id: "ibis-semantic-query", source: "ibis", terms: ["Ibis", "Expr", "Table", "backend", "DuckDB", "Polars", "Arrow"], impactFloor: "note", localContractHint: "backend-independent semantic query projection over normalized relations", localPaths: ["packages/qualification-workflow/", "spec/profiles/"]},
	{id: "marimo-diagnostic-projection", source: "marimo", terms: ["marimo", "reactive", "notebook", "app", "SQL", "DuckDB", "Arrow"], impactFloor: "note", localContractHint: "interactive diagnostic/workbench projection only; notebook state is never workflow or qualification authority", localPaths: ["packages/qualification-workflow/"]},
