package epistemicplantupstreammonitor
...
import (
	...
	profile "github.com/fatb4f/factory/contracts/factory/workers/upstream-monitor/profiles_epistemic_plant_bootstrap:epistemicplantprofile"
)

#DispatcherResultProjection: close({
	invocation: dispatcher.#TaskInvocation
	completion: dispatcher.#TaskCompletion
	evidenceDocument: profile.#EpistemicPlantRunEvidence & {
		dispatcher!: profile.#EpistemicPlantDispatcherContext
	}
	...
	_invocationContext: profile.#EpistemicPlantDispatcherContext & {
	...
	_runRoot: "contracts/upstream-monitor/epistemic-plant-bootstrap/contract-surface/runs/\(evidenceDocument.run_id)"
