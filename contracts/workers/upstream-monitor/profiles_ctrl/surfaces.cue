...
ctrlSurfaceCatalogue: [
	...
	{id: "ascent-lattice-fixpoint", source: "ascent", terms: ["lattice", "Lattice", "join", "fixed point", "ascent!", "relation", "Datalog"], impactFloor: "note", localContractHint: "candidate executable lattice-closure oracle for EvaluationWorld/DPI experiments; monitor semantics without promoting Ascent into the qualification kernel", localPaths: ["projected:packages/qualification-workflow/", "projected:spec/profiles/"]},
	{id: "hydro-calm-lattice-boundary", source: "hydro", terms: ["CALM", "lattice", "monotonic", "coordination-free", "hydro_lang", "DFIR", "lattices"], impactFloor: "note", localContractHint: "reference for classifying monotone closure versus coordination/externalization boundaries; Hydro theory/runtime remains evidence until explicitly admitted", localPaths: ["projected:spec/", "projected:packages/qualification-workflow/"]},
	{id: "egglog-equivalence-saturation", source: "egglog", terms: ["egglog", "e-graph", "e-class", "eclass", "equality saturation", "Datalog", "rewrite", "union"], impactFloor: "note", localContractHint: "future candidate for heterogeneous realization equivalence and predicate-conservation experiments after the DPI hypothesis earns a local consumer", localPaths: ["projected:spec/", "projected:packages/qualification-workflow/"]},
	{id: "salsa-incremental-reconciliation", source: "salsa", terms: ["tracked", "input", "revision", "dependency", "memoized", "red-green", "cycle", "fixpoint"], impactFloor: "note", localContractHint: "algorithmic reference for dependency identity, revision invalidation, cycle handling, and selective recomputation across immutable EvaluationWorld revisions", localPaths: ["projected:packages/qualification-workflow/"]},
	{id: "flix-fixpoint-reference", source: "flix", terms: ["fixpoint", "relation", "lattice", "Datalog", "inject", "query"], impactFloor: "note", localContractHint: "independent language-level reference for relational and lattice fixpoint semantics; no Flix runtime adoption is implied", localPaths: ["projected:spec/", "projected:packages/qualification-workflow/"]},
	{id: "timoni-cue-composition", source: "timoni", terms: ["CUE", "module", "bundle", "OCI", "schema", "@embed", "registry", "runtime", "codegen"], impactFloor: "note", localContractHint: "CUE-native module/composition/OCI/schema-projection operational reference; Timoni patterns remain downstream of ctrl CUE authority", localPaths: ["projected:spec/", "projected:packages/qualification-workflow/"]},
	...
	{id: "cue-evaluator-evolution", source: "cue", terms: ["evalv3", "evalv4", "comprehension", "cycle", "cyclic", "self-reference", "concurrent cue.Value", "Unity"], impactFloor: "note", localContractHint: "forecast evaluator evolution that may affect future pinned semantic-engine qualification, especially cyclic/dependency-enabled declarative evaluation", localPaths: ["spec/", "projected:packages/qualification-workflow/"]},
	{id: "cue-extension-boundary", source: "cue", terms: ["user-defined function", "user-provided function", "validator", "referential transparency", "@inject", "value injection", "authorization", "RPC"], impactFloor: "note", localContractHint: "forecast pure-computation and declared-injection extension boundary; preserve separation between pure semantic realization and external actuation/admission", localPaths: ["spec/", "projected:integrations/", "projected:packages/qualification-workflow/"]},
	{id: "cue-module-registry", source: "cue", terms: ["Central Registry", "module", "OCI", "registry", "mirror", "replacement", "replace", "publish"], impactFloor: "note", localContractHint: "versioned OCI-backed semantic authority/module distribution and local replacement workflow for reproducible resolved authority sets", localPaths: ["spec/", "projected:contracts/"]},
	{id: "cue-native-lsp", source: "cue", terms: ["cue lsp serve", "LSP", "language server", "diagnostics", "organize imports", "embedded JSON", "embedded YAML"], impactFloor: "note", localContractHint: "native authoring/diagnostic projection around CUE authority; editor tooling remains downstream of semantic meaning", localPaths: ["spec/", "projected:developer-tooling/"]},
