...
_materializedBundleShape: tmpl.#PluginBundleSrcRootShape & {
	...
	contracts: {
		...
		cuePackages: [
			{id: "codeintel", path: "contracts/code-intel/lua-first-workflow.cue"},
			{id: "codeintel", path: "contracts/code-intel/checks.cue"},
			{id: "codeintel", path: "contracts/code-intel/recommendations.cue"},
		]
		requiredPaths: [
			"contracts/code-intel/lua-first-workflow.cue",
			"contracts/code-intel/checks.cue",
			"contracts/code-intel/recommendations.cue",
		]
	}
	generated: {
...
materializedBundleShapeValidationPlan: close({
	...
	negative: [
		"! cue export ./contracts/plugin-bundle/template/checks -e _negativeBottomChecks.staleIssue81CheckReferenceAccepted",
	]
})
